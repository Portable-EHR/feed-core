...
const { FeedRecord, FeedItemRecord, MultiOwned } = require('./dao');
...
class PractitionerJoined {
    legitIds(This) {
                    return MultiOwned({FeedRecord:PractitionerLegitIdRecord, This, ownerArrayProperty:this.legitIds, ownerLitObArrayName:'practices'}); }
}
class PractitionerRecord extends FeedItemRecord {
    #legitIds = [];
    static get TableName() { return 'Practitioner'; }
    static get Joined() { return new PractitionerJoined(); }
