...
class NodeConfig extends nodeCore_NodeConfig {
    ...
    constructor(srcJsOb, node) {
        ...
        const { feedId, epochStart, wtf, feedHubServer:feedHubServerId, feedHubCredentials:feedHubCredentialsId } = feedConfig;
        ...
        else if ('string' === feedHubDfltCredentialsId ) {
        ...
        const endpointParams = feedHubCredentials ? Object.assign({}, feedHubServer, {credentials:feedHubCredentialsId})
                                                  : feedHubServer;
        Object.defineProperty(this, '_feedHubServer',  {value: new Endpoint(endpointParams,  this, endpoint => FeedHubWebRequestMethods(endpoint))});
