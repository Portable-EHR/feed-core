...
class Provider {
    ...
    pushSinglePatientReachability(/*id*/) { throw new Error("Provider.pushSinglePatientReachability : Override me !"); }
    ...
    pushSinglePrivateMessageStatus(/*id*/) { throw new Error("Provider.pushSinglePrivateMessageStatus : Override me !"); }
    ...
    pullSinglePrivateMessageContent(/*id*/) { throw new Error("Provider.pullSinglePrivateMessageContent : Override me !"); }
    ...
    pullAppointmentBundle(/*params*/) { throw new Error("Provider.pullAppointmentBundle : Override me !"); }
    pullSingleAppointment(/*id*/) { throw new Error("Provider.pullSingleAppointment : Override me !"); }
    ...
    pushSingleRdvDisposition(/*id*/) { throw new Error("Provider.pushSingleRdvDisposition : Override me !"); }
