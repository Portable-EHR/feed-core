...
class Provider {
    ...
    pullPractitionerBundle(/*srcParams*/) { throw new Error("Provider.pullPractitionerBundle : Override me !"); }
    pullSinglePractitioner(/*params*/) { throw new Error("Provider.pullSinglePractitioner : Override me !"); }
    addSinglePractitioner(/*srcLitOb*/) { throw new Error("Provider.addSinglePractitioner : Override me !"); }
    updateSinglePractitioner(/*srcLitOb*/) { throw new Error("Provider.updateSinglePractitioner : Override me !"); }
    retireSinglePractitioner(/*srcLitObFragment*/) { throw new Error("Provider.retireSinglePractitioner : Override me !"); }
    searchPractitioner(/*searchStr*/) { throw new Error("Provider.searchPractitioner : Override me !"); }
    ...
    pullPatientBundle(/*srcParams*/) { throw new Error("Provider.pullPatientBundle : Override me !"); }
    pullSinglePatient(/*params*/) { throw new Error("Provider.pullSinglePatient : Override me !"); }
    addSinglePatient(/*srcLitOb*/) { throw new Error("Provider.addSinglePatient : Override me !"); }
    updateSinglePatient(/*srcLitOb*/) { throw new Error("Provider.updateSinglePatient : Override me !"); }
    retireSinglePatient(/*srcLitObFragment*/) { throw new Error("Provider.retireSinglePatient : Override me !"); }
    searchPatient(/*searchStr*/) { throw new Error("Provider.searchPatient : Override me !"); }
    ...
    pushSinglePatientReachability(/*srcLitOb*/) { throw new Error("Provider.pushSinglePatientReachability : Override me !"); }
    ...
    pushSinglePrivateMessageStatus(/*srcLitOb*/) { throw new Error("Provider.pushSinglePrivateMessageStatus : Override me !"); }
    ...
    pullSinglePrivateMessageContent(/*params*/) { throw new Error("Provider.pullSinglePrivateMessageContent : Override me !"); }
    ...
    pullAppointmentBundle(/*srcParams*/) { throw new Error("Provider.pullAppointmentBundle : Override me !"); }
    pullSingleAppointment(/*params*/) { throw new Error("Provider.pullSingleAppointment : Override me !"); }
    ...
    pushSingleRdvDisposition(/*srcLitOb*/) { throw new Error("Provider.pushSingleRdvDisposition : Override me !"); }

    //endregion

    //region Backend ops

    pullBackendIdIssuersBundle(/*srcParams*/) { throw new Error("Provider.pullBackendIdIssuersBundle : Override me !"); }
    pullBackendPatientBundle(/*srcParams*/) { throw new Error("Provider.pullBackendPatientBundle : Override me !"); }


    pullSingleBackendPatientReachability(/*params*/) { throw new Error("Provider.pullSingleBackendPatientReachability : Override me !"); }


    pushSinglePrivateMessageNotification(/*srcLitOb*/) { throw new Error("Provider.pushSinglePrivateMessageNotification : Override me !"); }
