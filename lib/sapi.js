...
class Provider {
    ...
    bindFeedOps() {
        ...
        for (let [sapi_pushSingle, FeedItem] of This._PushSingles()) {
            const feedOp = srcParams => FeedItem.DaoPushSingle(srcParams, feed);
            feedOp.FeedItem = FeedItem;
            this[sapi_pushSingle.name] = feedOp;
        }
        ...
        for (let [sapi_updateSingle, FeedItem] of This._UpdateSingles()) {
            const feedOp = srcLitOb => FeedItem.DaoUpdateSingle(srcLitOb, feed);
            feedOp.FeedItem = FeedItem;
            this[sapi_updateSingle.name] = feedOp;
        }
