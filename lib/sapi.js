...
const FeedOpsProto = {};
function FeedOps({sapiPullBundle, sapiPullSingle, sapiPushSingle, sapiAddSingle, sapiUpdateSingle, sapiRetireSingle}={}) {
    const o = Object.create(FeedOpsProto);
    Object.assign(o,{sapiPullBundle, sapiPullSingle, sapiPushSingle,
                            sapiAddSingle, sapiUpdateSingle, sapiRetireSingle});
    return o;
}
