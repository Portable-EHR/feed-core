...
const { allNonOverriddenProtoFunctionsAlongThePrototypeChain, zip, strToDate, capitalizeName, niceJSON,
...
class FeedRecord {
    ...
    static Setup() {
        ...
        for (let [joinedPropertyFnc, propFncName] of allNonOverriddenProtoFunctionsAlongThePrototypeChain(Joined)) {
            //  QUICK HACK
