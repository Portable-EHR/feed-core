...
const { groupBy, onlyDate, dateAdd, Enum, EItem, normalizeString, normalizeName, normalizePhoneNumber,
        dbMsg, } = require('../../nodeCore/lib/utils');
...
class PatientReachabilityRecord extends FeedRecord {
    ...
    toApiLitOb(apiLitOb={}) {   //  Full fledged version, just in case ContactRecord becomes a FeedItemRecord too.
        ...
        return { feedItemId, isPehrReachable, ...apiLitOb };
    }
     ...
     */
    static async Insert({srcOb, validationErrors=[]}) {
        validationErrors.push(`Insert of ${this.FeedItemName} is not supported.`);
