...
const { FeedRecord, FeedItemRecord, ReferencedFeedRecordSetup,
...
class MJoined extends RecordJoined {
    ...
    uFeedId() {
        return Referenced({FeedRecord:URecord, referenceIdProperty:this.uFeedId, referencePropertyName:'u', colNameJoiningToReferenced:'u_id'}); }
}
...
class HJoined extends RecordJoined {
    ns() {
        return MultiOwned({FeedRecord:NRecord, ownerArrayProperty:this.ns}); }
}
...
class O0Joined extends RecordJoined {
    nextG() {
        return UniOwned({FeedRecord:G0Record, ownerProperty:this.nextG, colNameJoiningToOwned: 'next_g_id'}); }
}
...
class G1Joined extends RecordJoined {
    os() {
        return MultiOwned({FeedRecord:O0Record, ownerArrayProperty:this.os, colNameJoiningToOwner:'prev_g_id'}); }
}
...
class O1Joined extends RecordJoined {
    nextG() {
        return UniOwned({FeedRecord:G1Record, ownerProperty:this.nextG, colNameJoiningToOwned:'next_g_id'}); }
}
...
class G2Joined extends RecordJoined {
    i() {
        return UniOwned({FeedRecord:IRecord, ownerProperty:this.i }); }
    hs() {
        return MultiOwned({FeedRecord:HRecord, ownerArrayProperty:this.hs }); }
    // os() {
    //     return MultiOwned({FeedRecord:O1Record, ownerArrayProperty:this.os, colNameJoiningToOwner:'prev_g_id'}); }
}
...
class FJoined extends RecordJoined {
    g() {
        return UniOwned({FeedRecord:G2Record, ownerProperty:this.g }); }
}
...
class EJoined extends RecordJoined {
    m1() {
        return UniOwned({FeedRecord:MRecord, ownerProperty:this.m1, colNameJoiningToOwned:'m1_id'}); }
    m2() {
        return UniOwned({FeedRecord:MRecord, ownerProperty:this.m2, colNameJoiningToOwned:'m2_id'}); }
}
...
class KJoined extends RecordJoined {
    i1() {
        return UniOwned({FeedRecord:IRecord, ownerProperty:this.i1, colNameJoiningToOwned:'i1_id'}); }
    i2() {
        return UniOwned({FeedRecord:IRecord, ownerProperty:this.i2, colNameJoiningToOwned:'i2_id'}); }
}
...
class CJoined extends RecordJoined {
    d() {
        return UniOwned({FeedRecord:DRecord, ownerProperty:this.d}); }
}
...
class JJoined extends RecordJoined {
    m()  {
        return UniOwned({FeedRecord:MRecord, ownerProperty:this.m}); }
    cs() {
        return MultiOwned({FeedRecord:CRecord, ownerArrayProperty:this.cs}); }
}
...
class LJoined extends RecordJoined {
    es() {
        return MultiOwned({FeedRecord:ERecord, ownerArrayProperty:this.es}); }
}
...
class BJoined extends RecordJoined {
    i() {
        return UniOwned({FeedRecord:IRecord, ownerProperty:this.i, }); }
    j() {
        return UniOwned({FeedRecord:JRecord, ownerProperty:this.j, }); }
    k() {
        return UniOwned({FeedRecord:KRecord, ownerProperty:this.k, }); }
}
...
class P0Joined extends RecordJoined {
    qs() {
        return MultiOwned({FeedRecord:Q0Record, ownerArrayProperty: this.qs}); }
}
...
class P1Joined extends RecordJoined {
    p0() {
        return UniOwned({FeedRecord:P0Record, ownerProperty:this.p0 }); }
    qs() {
        return MultiOwned({FeedRecord:Q1Record, ownerArrayProperty: this.qs}); }
}
...
class AJoined extends RecordJoined {
    j1() {
        return UniOwned({FeedRecord:JRecord, ownerProperty:this.j1, colNameJoiningToOwned:'j1_id' }); }
    j2() {
        return UniOwned({FeedRecord:JRecord, ownerProperty:this.j2, colNameJoiningToOwned:'j2_id' }); }
    f()  {
        return UniOwned({FeedRecord:FRecord, ownerProperty:this.f }); }
    l()  {
        return UniOwned({FeedRecord:LRecord, ownerProperty:this.l }); }
    p()  {
        return UniOwned({FeedRecord:P1Record, ownerProperty:this.p }); }
    bs() {
        return MultiOwned({FeedRecord:BRecord, ownerArrayProperty:this.bs}); }
}
