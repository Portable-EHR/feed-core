...
const { FeedRecord, FeedItemRecord, ReferencedFeedRecordSetup, UniOwned, MultiOwned, Referenced } = require('./dao');
...
class URecord extends FeedRecord {
    ...
    static get Joined() { return new UJoined(); }
...
class DRecord extends FeedRecord {
    ...
    static get Joined() { return new DJoined(); }
...
class IRecord extends FeedRecord {
    ...
    static get Joined() { return new IJoined(); }
...
class MJoined {
    ...
    uFeedId(This) {
        return Referenced({FeedRecord:URecord, This, referenceIdProperty:this.uFeedId, referencePropertyName:'u', colNameJoiningToReferenced:'u_id'}); }
}
class MRecord extends FeedRecord {
    static get TableName() { return 'M'; }
    static get Joined() { return new MJoined(); }
...
class NRecord extends FeedRecord {
    ...
    static get Joined() { return new NJoined(); }
...
class HJoined {
    ns(This) {
        return MultiOwned({FeedRecord:NRecord, This, ownerArrayProperty:this.ns}); }
}
class HRecord extends FeedRecord {
    #g_id;
    #ns=[];
    static get TableName() { return 'H'; }
    static get Joined() { return new HJoined(); }
...
class G0Record extends FeedRecord {
    ...
    static get Joined() { return new G0Joined(); }
...
class O0Joined {
    nextG(This) {
        return UniOwned({FeedRecord:G0Record, This, ownerProperty:this.nextG, colNameJoiningToOwned: 'next_g_id'}); }
}
class O0Record extends FeedRecord {
    #prev_g_id;
    static get TableName() { return 'O'; }
    static get Joined() { return new O0Joined(); }
...
class G1Joined {
    os(This) {
        return MultiOwned({FeedRecord:O0Record, This, ownerArrayProperty:this.os, colNameJoiningToOwner:'prev_g_id'}); }
}
class G1Record extends FeedRecord {
    #os=[];
    static get TableName() { return 'G'; }
    static get Joined() { return new G1Joined(); }
...
class O1Joined {
    nextG(This) {
        return UniOwned({FeedRecord:G1Record, This, ownerProperty:this.nextG, colNameJoiningToOwned:'next_g_id'}); }
}
class O1Record extends FeedRecord {
    #prev_g_id;
    static get TableName() { return 'O'; }
    static get Joined() { return new O1Joined(); }
...
class G2Joined {
    i(This) {
        return UniOwned({FeedRecord:IRecord, This, ownerProperty:this.i }); }
    hs(This) {
        return MultiOwned({FeedRecord:HRecord, This, ownerArrayProperty:this.hs }); }
    // os(This) {
    //     return MultiOwned({FeedRecord:O1Record, This, ownerArrayProperty:this.os, colNameJoiningToOwner:'prev_g_id'}); }
}
class G2Record extends FeedRecord {
    #hs=[];
    #os=[];
    static get TableName() { return 'G'; }
    static get Joined() { return new G2Joined(); }
...
class FJoined {
    g(This) {
        return UniOwned({FeedRecord:G2Record, This, ownerProperty:this.g }); }
}
class FRecord extends FeedRecord {
    static get TableName() { return 'F'; }
    static get Joined() { return new FJoined(); }
...
class EJoined {
    m1(This) {
        return UniOwned({FeedRecord:MRecord, This, ownerProperty:this.m1, colNameJoiningToOwned:'m1_id'}); }
    m2(This) {
        return UniOwned({FeedRecord:MRecord, This, ownerProperty:this.m2, colNameJoiningToOwned:'m2_id'}); }
}
class ERecord extends FeedRecord {
    #l_id;
    static get TableName() { return 'E'; }
    static get Joined() { return new EJoined(); }
...
class KJoined {
    i1(This) {
        return UniOwned({FeedRecord:IRecord, This, ownerProperty:this.i1, colNameJoiningToOwned:'i1_id'}); }
    i2(This) {
        return UniOwned({FeedRecord:IRecord, This, ownerProperty:this.i2, colNameJoiningToOwned:'i2_id'}); }
}
class KRecord extends FeedRecord {
    static get TableName() { return 'K'; }
    static get Joined() { return new KJoined(); }
...
class CJoined {
    d(This) {
        return UniOwned({FeedRecord:DRecord, This, ownerProperty:this.d}); }
}
class CRecord extends FeedRecord {
    #j_id;
    static get TableName() { return 'C'; }
    static get Joined() { return new CJoined(); }
...
class JJoined {
    m(This)  {
        return UniOwned({FeedRecord:MRecord, This, ownerProperty:this.m}); }
    cs(This) {
        return MultiOwned({FeedRecord:CRecord, This, ownerArrayProperty:this.cs}); }
}
class JRecord extends FeedRecord {
    #cs=[];
    static get TableName() { return 'J'; }
    static get Joined() { return new JJoined(); }
...
class LJoined {
    es(This) {
        return MultiOwned({FeedRecord:ERecord, This, ownerArrayProperty:this.es}); }
}
class LRecord extends FeedRecord {
    #a_id;
    #es=[];
    static get TableName() { return 'L'; }
    static get Joined() { return new LJoined(); }
...
class BJoined {
    i(This) {
        return UniOwned({FeedRecord:IRecord, This, ownerProperty:this.i, }); }
    j(This) {
        return UniOwned({FeedRecord:JRecord, This, ownerProperty:this.j, }); }
    k(This) {
        return UniOwned({FeedRecord:KRecord, This, ownerProperty:this.k, }); }
}
class BRecord extends FeedRecord {
    #a_id;
    static get TableName() { return 'B'; }
    static get Joined() { return new BJoined(); }
...
class Q0Record extends FeedRecord {
    ...
    static get Joined() { return new Q0Joined(); }
...
class P0Joined {
    qs(This) {
        return MultiOwned({FeedRecord:Q0Record, This, ownerArrayProperty: this.qs}); }
}
class P0Record extends FeedRecord {
    #qs=[];
    static get TableName() { return 'P'; }
    static get Joined() { return new P0Joined(); }
...
class Q1Record extends Q0Record {
    static get Joined() { return new Q1Joined(); }
}

class P1Joined {
    p0(This) {
        return UniOwned({FeedRecord:P0Record, This, ownerProperty:this.p0 }); }
    qs(This) {
        return MultiOwned({FeedRecord:Q1Record, This, ownerArrayProperty: this.qs}); }
}
class P1Record extends FeedRecord {
    #qs=[];
    static get TableName() { return 'P'; }
    static get Joined() { return new P1Joined(); }
...
class AJoined {
    j1(This) {
        return UniOwned({FeedRecord:JRecord, This, ownerProperty:this.j1, colNameJoiningToOwned:'j1_id' }); }
    j2(This) {
        return UniOwned({FeedRecord:JRecord, This, ownerProperty:this.j2, colNameJoiningToOwned:'j2_id' }); }
    f(This)  {
        return UniOwned({FeedRecord:FRecord, This, ownerProperty:this.f }); }
    l(This)  {
        return UniOwned({FeedRecord:LRecord, This, ownerProperty:this.l }); }
    p(This)  {
        return UniOwned({FeedRecord:P1Record, This, ownerProperty:this.p }); }
    bs(This) {
        return MultiOwned({FeedRecord:BRecord, This, ownerArrayProperty:this.bs}); }
}
class ARecord extends FeedItemRecord {
    #bs = [];
    static get TableName() { return 'A'; }
    static get Joined() { return new AJoined(); }
    ...
    static get _FieldsToInsertAndUpdate() {
        ...
        return [
            ...
            //  .whatever_id which is specified as .colNameJoiningToOwned of a Joined UniOwned() entry,
            //  or as .colNameJoiningToReferenced of a Joined Referenced() entry.
            { colName:'f_id',                                                   },
            { colName:'j1_id',                                                  },
            { colName:'j2_id',                                                  },
            // { colName:'l_id',                                                   },
