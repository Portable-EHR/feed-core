...
const { onlyDate, commentsLitOb, Enum, EItem, } = require('../../nodeCore/lib/utils');
...
class Feed {
    constructor(srcJsOb, feedConfigAlias, feeds) {
        ...
        const addFeedHubEndpoint = () => {
            ...
            if ( !feedHubServerAlias ) {
                _invalidFeedHubServerMsgs.push(`neither ${feedConfigAlias} .feedHubServer [${ownFeedHubServerAlias
                    }] in .feedConfigs {} section nor ${netFlavorAlias} .feedHubServer [${config.feedHubServerAlias
                    }] in .netFlavors {} section is a valid alias string.`);
            } // return undefined;
            else {
                ...
                if ( !feedHubServer ) {                     //  feed.feedHubServer undefined in feedHubServers
                    _invalidFeedHubServerMsgs.push(`${fullTag} .feedHubServer "${feedHubServerAlias
                    ...
                    if ('string' === typeof ownFeedHubCredentialsAlias) {
                        ...
                        if(undefined === overriddenFeedHubCredentials) {
                            _invalidCredentialsMsgs.push(`feedConfig [${feedConfigAlias}] .feedHubCredentials: "${ownFeedHubCredentialsAlias
                        ...
                        if ('string' === typeof feedHubCredentialsAlias ) {
                            ...
                            if(undefined === originalFeedHubCredentials) {
                                _invalidCredentialsMsgs.push(`feedConfig [${feedConfigAlias}] .feedHubServer [${
                            ...
                            _invalidCredentialsMsgs.push(`For feedConfig [${feedConfigAlias}] .feedHubServer [${feedHubServerAlias
                                }] .scheme "${scheme}", either its own default feedHubServer.credentials, or feedConfig [${feedConfigAlias
                                }] .feedHubCredentials MUST specify an entry of the .credentials {} section of config file [${configFQN}].`);
                        }
                    }
    ...
    bind() {
        Object.defineProperty(this, "_feedHubWeb", {configurable:true, value: this.feedHubEndpoint.bindWebRequestMethods()});
    }
