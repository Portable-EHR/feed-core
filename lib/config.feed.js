...
class Feeds {
    ...
    constructor(feedJsOb, feedId, config) {
        Object.defineProperty(this, "_config", {value: config});
        const {Feed} = this;

        const feed = new Feed(feedJsOb, feedId, this);
        this[feedId] = feed;
        feed.bind();
    ...
    async reportStatus(dst) {
        ...
        for (let feed of this) {
            result[feed.id] = await feed.reportStatus();
        }
        if (dst) {
...
class Feed {
    constructor(srcJsOb, id, feeds) {
        Object.defineProperty(this, "_id", {value: id});     // default non-{writable|enumerable|configurable}
    ...
    static get feedIdname() { return this.feedname+'Id'; }
