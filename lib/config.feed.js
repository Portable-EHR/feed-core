...
const { PullBackendPatientBundle, PullBackendIdIssuersBundle,
        PullSingledBackendPatientReachability, PushSinglePrivateMessageNotification } = require('./feedhub.ops');
        ...
        if (feedHubEndpoint) {
            ...
            Object.defineProperty(this, '_feedHubApi', {value: {
                    ...
                    get pullBackendPatientBundle() {
                        const pullBackendPatientBundleOp = new PullBackendPatientBundle(feed, {}, {verbose});
                    ...
                    get pullBackendIdIssuersBundle() {
                        const pullBackendIdIssuersBundleOp = new PullBackendIdIssuersBundle(feed, {}, {verbose});
                    ...
                    get pullSingleBackendPatientReachability() {
                        const pullSingledBackendPatientReachabilityOp = new PullSingledBackendPatientReachability(feed, {}, {verbose});
                    ...
                    get pushSinglePrivateMessageNotification() {
                        const pushSinglePrivateMessageNotificationOp = new PushSinglePrivateMessageNotification(feed, {feedItem:undefined}, {verbose},);
