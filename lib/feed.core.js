...
class FeedOp {
    ...
    get feed() {      return {};    }
    get feedAlias() {    return this.feed.alias; }           //  _owner is the adapter here.
    ...
    get toTag() { return (!this.isOfFeed) !== (undefined===this.isToFeed)  ? 'FeedHub' : `${this.FeedProvider} Feed`; }// XOR
